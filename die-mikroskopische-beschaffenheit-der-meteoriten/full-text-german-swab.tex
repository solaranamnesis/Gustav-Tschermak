...
\begin{titlepage} % Suppresses headers and footers on the title page
	...
	\vspace{0.75\baselineskip} % Whitespace above the title
        ...
        {\Huge Die mikroskopische Beschaffenheit der Meteoriten erl"autert durch photographische Abbildungen} % Title
	...
	{\Large herausgegeben von G. Tschermak.} % Subtitle or further description
	...
	%------------------------------------------------
 	...
 	{Die Aufnahmen von J. Grimm in Offenburg.\\ 25 Tafeln mit 100 mikrophotographischen Abbildungen.} % Subtitle or further description
...
\paragraph*{}
G. Rose hat eine Einteilung der Meteoriten nach den herrschenden Gemengteilen vorgeschlagen, die mit den Meteoreisen beginnt und mit denjenigen Steinen schlie"st, welche die meiste "Ahnlichkeit mit tellurischen Felsarten haben.\footnote{\swabfamily{Beschreibung und Einteilung der Meteoriten. Berlin, 1864.}} Diese Folge verl"auft ungef"ahr im selben Sinne, wie die Abnahme des spezifischen Gewichtes und ist insofern eine geologische zu nennen, als nach der Parallele, welche von Daubrée zwischen der Zusammensetzung der Meteoriten und jener unseres Planeten gezogen wurde, zuerst der angenommene metallische Kern der Erde als die "alteste Bildung, hierauf die spezifisch leichteren Silikatmassen als die j"ungeren Bildungen in Betracht kommen.\footnote{\swabfamily{Etudes recentes sur les Météorites. Journal de savants 1870.}} Wenn die Meteoriten Splitter sind, welche von einem oder von mehreren kleinen planetarischen K"orpern herr"uhren, so wird man sich jedes solche kleine Gestirn "ahnlich wie die Erde gebaut denken, also in der Vorstellung eine metallische Kugel mit einer Silikatrinde konstruieren, welche letztere aus Erstarrungsprodukten und aus Tuffmassen bestand.\footnote{\swabfamily{Tschermak. Die Bildung der Meteoriten und der Vulkanismus. Sitzungsber. d. Wiener Akad. Bd. 71. Abt. 2. (1875.)}}
...
\paragraph{}
Das Gemenge von Diopsid und Enstatit ist bisher blo"s durch den Stein von Busti bei Goruckpur (gefallen am 2. Dezember 1852) repr"asentiert. Maskelyne hat denselben untersucht, die einzelnen Gemengteile gemessen und analysirt.\footnote{\swabfamily{Proceedings of the Royal Society 18. 146.}} Das Gef"uge ist beinahe kristallinisch, doch unterscheidet man Kristalle und gr"o"sere Splitter, welche in einer aus feinen Splittern bestehenden Grundmasse liegen. Flight hat eine Abbildung des ganzen Steines ver"offentlicht, welche die ungleichartige Mengung deutlich wahrnehmen lasst.\footnote{\swabfamily{Geological Magazine, September 1875.}} Der Stein hat keine Rinde.
...
Der Enstatit bildet meist gro"se, aber auch kleine K"orner. An einem der letzteren konnte ich scharfe Umrisse wahrnehmen. Der Schnitt ging ungef"ahr parallel \emph{a} = 1 0 0. Die Endigung des Kristalles war dreifl"achig, eine Fl"ache entsprach der Zone \emph{p} \emph{a},  die beiden andern den Zonen \emph{u} \emph{b}.\footnote{\swabfamily{Hier und im Folgenden sind f"ur Bronzit und Enstatit \emph{a} = \emph{b} bei v. Rath, \emph{u} = \emph{u} bei v. Rath. \emph{b} = \emph{a} bei v. Rath, \emph{p} = \emph{k} bei v. Rath.}} Die K"orner sind von vielen feinen unregelm"a"sigen Spr"ungen durchsetzt, abgesehen von den Spaltrissen, welche beim Pr"aparieren entstehen. Einschl"usse sind nur in geringer Menge vorhanden und bestehen aus opaken K"ornchen, seltener aus schwarzen Nadeln.
...
Mit der angegebenen mikroskopischen Beschaffenheit stimmt die Analyse Rammelsbergs,\footnote{\swabfamily{Monatsberichte der Berliner Akademie. 1861, p. 895.}} welche au"ser den Bestandteilen des Enstatits auch Tonerde, Kalk and Alkalien in geringer Menge angibt, vollkommen "uberein.
...
Das Innere der beiden ersteren ist hell graulichgelb mit gr"o"seren lichtgelbgr"unen K"ornern. Sowohl diese K"orner als auch die "ubrige Masse bestehen aus einem Bronzit mit 20.5 resp. 17.5 Eisenoxydul. In dem Stein von Manegaum fand Maskelyne auch geringe Mengen von Chromit und gediegen Eisen.\footnote{\swabfamily{Philosophical Transactions 160. p. 189. (1870.)}} Im Stein von Ibbenb"uhren konnte v. Rath nur Bronzit erkennen, abgesehen von wenigen Einschl"ussen.\footnote{\swabfamily{Monatsberichte der Berliner Akademie 1872, p. 27. Pogg. Ann. 146. p. 474.}}
...
Die Chondren, welche schon von Reichenbach\footnote{\swabfamily{Poggendorffs Annalen, Band 111, p. 353.}} und G. Rose als merkw"urdige Bildungen hervorgehoben wurden, sind eine charakteristische Form, in welcher dieselben K"orper, die auch in der Grundmasse vorkommen, einzeln oder gemengt auftreten. Ihr Zusammenvorkommen ist aber ein anderes, als jenes der Gemengteile in echt kristallinischem Gestein, indem nicht Chondren von bestimmter Beschaffenheit nebeneinander liegen, sondern die verschiedenartigsten im selben Gemenge angetroffen werden, in der Art wie die verschiedenartigsten Minerale in einem Tuff beisammen liegen. Beispiele geben Taf. 7, Fig. 1 bis 4.
...
\pagestyle{fancy}
\fancyhf{}
\rhead{\swabfamily{\swabfamily{Tafel 1.}}}
\cfoot{\swabfamily{\thepage}}
...
\caption{\swabfamily{\small Figur 1 --- Eukrit von Juvinas. Eine Stelle von gr"oberer Textur im polaris. Lichte. Vergr"o"serung 75.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 2 --- Eisenhaltiger tellurischer Eukrit von Ovifak im polaris. Lichte. Vergr"o"serung 75.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 3 --- Eukrit von Juvinas. Eine Stelle mit zweierlei Textur. Vergr"o"serung 75.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 4 --- Eukrit von Juvinas. Mit Durchschnitten von Lamellen eines gelben Silikates. Vergr"o"serung 75.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 1 --- Anorthit in dem Eukrit von Stannern. Vergr"o"serung 160.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 2 --- Anorthit mit vielen rundlichen Glaseinschl"ussen. Eukrit von Juvinas. Vergr"o"serung 160.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 3 --- Anorthit mit langgezogenen Glaseinschl"ussen. Eukrit von Juvinas. Vergr"o"serung 160.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 4 --- Kristallbruchst"uck von Anorthit. Eukrit von Juvinas. Polaris. Licht. Vergr"o"serung 75.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 1 --- Brauner Augit im Eukrit von Juvinas. Vergr"o"serung 250.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 2 --- Gelber k"orniger Augit im Eukrit von Juvinas. Vergr"o"serung 250.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 3 --- Eukrit von Stannern Tuffcharakter. Vergr"o"serung 75.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 4 --- Eukrit von Shergotty. Gleichf"ormig kristallinisch. Vergr"o"serung 65.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 1 --- Howardit von Loutolaks mit sehr ausgesprochenem Tuffcharakter. Vergr"o"serung 65.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 2 --- Eukritbruchst"uck im Howardit von Loutolaks. Vergr"o"serung 160.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 3 --- Bronzit im Howardit von Massing, Schnitt beil"aufig parallel 1 1' 0. Vergr"o"serung 160.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 4 --- Bruchst"uck von Augit im Howardit von Loutolaks. Vergr"o"serung 200.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 1 --- Bustit von Busti bei Gorukpur. Enstatit und Plagioklas. Vergr"o"serung 65.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 2 --- Diopsid und Plagioklas im Stein von Busti. Vergr"o"serung 65.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 3 --- Chladnit von Bishopville. Enstatit, Plagioklas, Magnetkies. Vergr"o"serung 75.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 4 --- Plagioklas im Chladnit von Bishopville im polaris. Lichte. Vergr"o"serung 75.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 1 --- Bronzit in dem Stein von Shalka. Vergr"o"serung 160.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 2 --- Diogenit von Ibbenb"uhren. Bronzit. Vergr"o"serung 80.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 3 --- Amphoterit von Manbhoom. Olivin, Bronzit, Magnetkies. Vergr"o"serung 200.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 4 --- Chassignit von Chassigny. Olivin, Chromit. Vergr"o"serung 80.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 1 --- Chondrit von Lancé. K"ugelchen, Kn"ollchen, Fetzen und Splitter in einer schwarzen Grundmasse. Vergr"o"serung 65.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 2 --- Chondrit von Mez"o-Madaras. Ein porphyrisches, ein dichtes und mehrere k"ornige K"ugelchen. Vergr"o"serung 75.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 3 --- Chondrit von Tieschitz. K"ugelchen, davon zwei mit Eindr"ucken, Kn"ollchen, Splitter. Vergr"o"serung 75.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 4 --- Chondrit von Homestead. Ein porphyrisches und ein strahliges K"ugelchen. Vergr"o"serung 65.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 1 --- Ein porphyrisches Chondrum, K"orner und ein kleineres Chondrum einschlie"send. Stein von Dhurmsala. Vergr"o"serung 8.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 2 --- K"orniges Chondrum in dem Stein von Seres. Vergr"o"serung 65.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 3 --- K"ugelchen mit Glaseinschluss, aus dem Chondrit von Lancé. Vergr"o"serung 160.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 4 --- Monosomatisches K"ugelchen mit dunklerem Kern und blasser H"ulle. Chondrit von Tieschitz. Vergr"o"serung 160.}}
\end{figure}
\vspace*{\fill}
\clearpage

\rhead{\swabfamily{Tafel 9.}}
...
\caption{\swabfamily{\small Figur 1 --- Olivinkristall in einem glasreichen K"ugelchen des Steines von Borkut. Vergr"o"serung 160.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 2 --- Olivinkristall mit Bronzit- und Glaseinschl"ussen im Chondrit von Aigle. Vergr"o"serung 70.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 3 --- Olivinkristall mit einem geweihf"ormigen Glaseinschluss im Chondrit von Seres. Vergr"o"serung 160.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 4 --- Monosomatisches Olivink"ugelchen links mit einem gleichorientierten Fortsatz. Chondrit von Dhurmsala. Vergr"o"serung 35.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 1 --- Skeletartiger Olivin mit fadenf"ormigen Glaseinschl"ussen in dem Chondrit von Tieschitz. Vergr"o"serung 160.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 2 --- Gef"achertes K"ugelchen aus abwechselnden Lamellen von Olivin und Glas bestehend. Chondrit von Mez"o-Madaras. Vergr"o"serung 200.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 3 --- Olivin von gestrickter Form in einem K"ugelchen des Steines von Homestead. Vergr"o"serung 200.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 4 --- Olivink"ugelchen aus mehreren Systemen abwechselnder Olivin- und Glaslamellen bestehend. Chondrit von Knyahinya. Vergr"o"serung 25.}}
\end{figure}
\vspace*{\fill}
\clearpage

\rhead{\swabfamily{Tafel 11.}}
...
\caption{\swabfamily{\small Figur 1 --- Ein monosomatisches Olivink"ugelchen mit dicker Rinde in dem Chondrit von Alfianello. Vergr"o"serung 60.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 2 --- Olivink"ugelchen, im Innern monosomatisch, mit dicker Rinde in dem Stein von Mez"o-Madaras. Vergr"o"serung 70.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 3 --- Polysomatisches Olivink"ugelchen mit vielem Glas und dicker Rinde in dem Chondrit von Seres. Vergr"o"serung 160.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 4 --- Olivin in gr"o"seren, Bronzit in kleineren Kristallen und Glasgrundmasse in einem gro"sen K"ugelchen des Steines von Knyahinya. Vergr"o"serung 70.}}
\end{figure}
\vspace*{\fill}
\clearpage

\rhead{\swabfamily{Tafel 12.}}
...
\caption{\swabfamily{\small Figur 1 --- L"angsschnitt eines Bronzitkristalls in dem Chondrit von Mocs. Vergr"o"serung 160.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 2 --- Teil eines Bronzitl"angsschnittes mit vielen Einschl"ussen. Stein von Alexinaé. Vergr"o"serung 160.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 3 --- Polysomatisches Bronzitk"ugelchen mit Glaseinschluss im Chondrit von Pultusk. Vergr"o"serung 70.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 4 --- Teil eines Bronzitk"ugelchens von gitterartig stengeliger Textur im Stein von Knyahinya. Vergr"o"serung 70.}}
\end{figure}
\vspace*{\fill}
\clearpage

\rhead{\swabfamily{Tafel 13.}}
...
\caption{\swabfamily{\small Figur 1 --- Bronzitk"ugelchen, radialfaserig, aus dem Stein von Tipperary. Vergr"o"serung 70.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 2 --- Bronzitk"ugelchen, undeutlich radialfaserig aus dem Stein von Gnadenfrei. Vergr"o"serung 60.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 3 --- Durchschnitt eines aus vier Faserb"undeln bestehenden K"ugelchens im Stein von Mez"o-Madaras. Vergr"o"serung 60.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 4 --- Dichtes Bronzitk"ugelchen quer gegen die Faserung geschnitten, im Stein von Knyahinya. Vergr"o"serung 80.}}
\end{figure}
\vspace*{\fill}
\clearpage

\rhead{\swabfamily{Tafel 14.}}
...
\caption{\swabfamily{\small Figur 1 --- Bronzitk"ugelchen, in einem L"angsschnitte die f"acherartig divergierenden Fasern zeigend. Chondrit von Dhurmsala. Vergr"o"serung 60.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 2 --- Undeutlich faseriges Bronzitk"ugelchen mit d"unner Rinde. Chondrit von Mez"o-Madaras. Vergr"o"serung 60.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 3 --- Monticellit"ahnliches farbloses doppelbrechendes Silikat im Chondrit von Knyahinya. Vergr"o"serung 70.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 4 --- Dasselbe Silikat mit feinen Spaltrissen. Chondrit von Knyahinya. Vergr"o"serung 70.}}
\end{figure}
\vspace*{\fill}
\clearpage

\rhead{\swabfamily{Tafel 15.}}
...
\caption{\swabfamily{\small Figur 1 --- Zwei K"ugelchen, zumeist aus Augit bestehend, in dem Stein von Renazzo. Vergr"o"serung 70.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 2 --- Dieselben im polarisierten Lichte. Nicolhauptschnitte horizontal und vertikal.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 3 --- Ein Augitk"ugelchen, die Durchwachsung mehrerer Individuen zeigend. Chondrit von Mez"o-Madaras. Vergr"o"serung 160.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 4 --- Augit und Olivin, ein spreuartiges Gemenge darbietend. Chondrit von Renazzo. Vergr"o"serung 160.}}
\end{figure}
\vspace*{\fill}
\clearpage

\rhead{\swabfamily{Tafel 16.}}
...
\caption{\swabfamily{\small Figur 1 --- Plagioklas mit scharfeckigem Umriss im polarisierten Lichte. Chondrit von Murcia [?]. Vergr"o"serung 360.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 2 --- Plagioklask"ornchen mit rundlichem Umriss. Pol. Licht. Chondrit von Mocs. Vergr"o"serung 360.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 3 --- Plagioklas in zahlreichen kleinen K"ornchen mit Olivin verwachsen. Chondrit von Milena. Vergr"o"serung 70.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 4 --- Plagioklas mit Olivin und Magnetkies ein K"ugelchen bildend. Chondrit von Dhurmsala. Vergr"o"serung 80.}}
\end{figure}
\vspace*{\fill} 
\clearpage

\rhead{\swabfamily{Tafel 17.}}
...
\caption{\swabfamily{\small Figur 1 --- Maskelynit im Chondrit von Alfianello. Vergr"o"serung 300.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 2 --- Maskelynit in demselben Stein. Vergr"o"serung 60.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 3 --- Schwarze Kugel, zumeist aus Maskelynit bestehend, im Chondrit von Chateau Renard. Vergr"o"serung 160.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 4 --- Bl"auliche halbglasige Kugel im Chondrit von Tipperary. Vergr"o"serung 160.}}
\end{figure}
\vspace*{\fill}
\clearpage

\rhead{\swabfamily{Tafel 18.}}
...
\caption{\swabfamily{\small Figur 1 --- Glaskugel, Olivinkristall und Mikrolithe einschlie"send, aus dem Chondrit von Mez"o-Madaras. Vergr"o"serung 90.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 2 --- Teilweise entglaste Zwischenmasse in einer Olivinkugel des Steines von Renazzo. Vergr"o"serung 300.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 3 --- Glaseinschluss mit Libelle im Olivin des Steines von Lancé. Vergr"o"serung 300.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 4 --- Glaseinschl"usse im Olivin des Steines von Stauropol. Vergr"o"serung 300.}}
\end{figure}
\vspace*{\fill}
\clearpage

\rhead{\swabfamily{Tafel 19.}}
...
\caption{\swabfamily{\small Figur 1 --- Bronzitkugel mit sternf"ormigen Mikrolithen. Chrondrit von Mez"o-Madaras. Vergr"o"serung 60.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 2 --- Olivin-Doppelkugel aus dem Chondrit von Borkut. Vergr"o"serung 160.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 3 --- Eisenh"ulle einer Olivinkugel im Chondrit von Cabarras City. Vergr"o"serung 60.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 4 --- Chondrensplitter im Chondrit von Mez"o-Madaras. Vergr"o"serung 90.}}
\end{figure}
\vspace*{\fill}
\clearpage

\rhead{\swabfamily{Tafel 20.}}
...
\caption{\swabfamily{\small Figur 1 --- Olivinkugel im dem kohligen Chondrit von Cold-Bokkeveld. Vergr"o"serung 160.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 2 --- Feink"ornige lappige Chondren im Chondrit von Grosnaja. Vergr"o"serung 60.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 3 --- L"ocheriger Chondrit von Goalpara. Vergr"o"serung 25.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 4 --- K"orniger Chondrit von Erxleben. Vergr"o"serung 60.}}
\end{figure}
\vspace*{\fill}
\clearpage

\rhead{\swabfamily{Tafel 21.}}
...
\caption{\swabfamily{\small Figur 1 --- Vertikalschnitt durch die Rinde des Chondrits von Chateau Renard. Vergr"o"serung 70.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 2 --- Rinde des Chondrits von Mocs im Vertikalschnitt. Vergr"o"serung 70.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 3 --- Rinde des Chondrits von Mocs, ungef"ahr parallel durchschnitten. Vergr"o"serung 70.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 4 --- Parallelschnitt durch die Rinde des Eukrits von Juvinas. Vergr"o"serung 160.}}
\end{figure}
\vspace*{\fill}
\clearpage

\rhead{\swabfamily{Tafel 22.}}
...
\caption{\swabfamily{\small Figur 1 --- Netzartig verbundene Kl"ufte im Chondrit von Mocs. Vergr"o"serung 60.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 2 --- Gangf"ormige Masse im Chondrit von Mocs. Vergr"o"serung 20.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 3 --- Grahamit von der Sierra de Chaco. Splitter von Plagioklas und Bronzit. Vergr"o"serung 30.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 4 --- Plagioklas mit Einschl"ussen. Grahamit von der Sierra de Chaco. Vergr"o"serung 60.}}
\end{figure}
\vspace*{\fill} 
\clearpage

\rhead{\swabfamily{Tafel 23.}}
...
\caption{\swabfamily{\small Figur 1 --- Bronzit im Grahamit von der Sierra de Chaco. Vergr"o"serung 50.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 2 --- Augit und dichter Plagioklas in demselben Grahamit. Vergr"o"serung 70.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 3 --- Olivin mit feink"orniger Rinde neben Plagioklas in demselben Grahamit. Vergr"o"serung 50.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 4 --- Olivin mit Gitterzeichnung in demselben Grahamit. Vergr"o"serung 70.}}
\end{figure}
\vspace*{\fill}
\clearpage

\rhead{\swabfamily{Tafel 24.}}
...
\caption{\swabfamily{\small Figur 1 --- Plagioklasreiche Stelle in dem Mesosiderit von Estherville. Vergr"o"serung 70.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 2 --- Pekhamit, bronzit"ahnlich, aus dem Mesosiderit von Estherville. Vergr"o"serung 120.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 3 --- Olivin mit Einschl"ussen im Mesosiderit von Hainholz. Vergr"o"serung 120.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 4 --- Feink"ornige Grundmasse des Mesosiderits von Hainholz. Vergr"o"serung 120.}}
\end{figure}
\vspace*{\fill}
\clearpage

\rhead{\swabfamily{Tafel 25.}}
...
\caption{\swabfamily{\small Figur 1 --- K"orniger Tridymit im Siderophyr von Rittersgr"un im polaris. Lichte. Vergr"o"serung 60.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 2 --- Tridymitbl"attchen aus demselben Siderophyr im polaris. Lichte. Vergr"o"serung 100.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 3 --- Bronzit in demselben Siderophyr. Vergr"o"serung 60.}}
\end{figure}
\vspace*{\fill}
\clearpage
...
\caption{\swabfamily{\small Figur 4 --- Olivin mit feinen R"ohren im Pallasit von Brahin (links) Vergr"o"serung 300. und im P. von Krasnojarsk (rechts) Vergr"o"serung 200.}}
\end{figure}
\vspace*{\fill}
\clearpage
\end{document}
